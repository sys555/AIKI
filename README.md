...
- 🎯 Entry points to execute your program using `python -m <aiki>` or `$ aiki` with basic CLI argument parsing.
...
```py
from aiki import BaseClass
from aiki import base_function
